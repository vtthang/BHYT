...
public class HomeController {
    ...
    public String chooseimgPost(@ModelAttribute User user, @RequestParam("image_front") MultipartFile multipartFile1,@RequestParam("image_back") MultipartFile multipartFile2) throws IOException {
